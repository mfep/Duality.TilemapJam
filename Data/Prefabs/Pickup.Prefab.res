<root dataType="Struct" type="Duality.Resources.Prefab" id="129723834">
  ...
  <objTree dataType="Struct" type="Duality.GameObject" id="3844112519">
    ...
    <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1136467820">
      <_items dataType="Array" type="Duality.Component[]" id="1512261476">
        ...
        <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="2611921747">
          <active dataType="Bool">true</active>
          ...
          <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="1268439103">
            <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="1191595182">
              <item dataType="Struct" type="Duality.Components.Physics.CircleShapeInfo" id="2654101840">
                <density dataType="Float">1</density>
                <friction dataType="Float">0.3</friction>
                <parent dataType="ObjectRef">2611921747</parent>
    ...
    <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="553231414" surrogate="true">
      <header />
      <body>
        <keys dataType="Array" type="System.Object[]" id="1680171430">
          <item dataType="Type" id="223435776" value="Duality.Components.Transform" />
    ...
    <compTransform dataType="ObjectRef">1909460155</compTransform>
    <identifier dataType="Struct" type="System.Guid" surrogate="true">
      <header>
        <data dataType="Array" type="System.Byte[]" id="3093759398">b8hPvm8wlEilUmsJUtDJfA==</data>
      </header>
      <body />
    </identifier>
